...
@WebServlet(urlPatterns="/GreenJavaclassInit" , initParams= {@WebInitParam(name="mid",value="LG U+"), @WebInitParam(name="pwd",value="1234"), @WebInitParam(name="className",value="영어과")})
public class JavaclassInit extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// web.xml에 설정해 둔 초기변수/값을 가져온다.
