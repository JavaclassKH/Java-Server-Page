...
public class BoardUpdateOkCommand implements BoardInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String title = request.getParameter("content") == null ? "" : request.getParameter("content");
		...
		if(res != 0) request.setAttribute("message", "게시글 수정이 완료되었습니다");
		else request.setAttribute("message", "게시글 수정에 실패하였습니다");
