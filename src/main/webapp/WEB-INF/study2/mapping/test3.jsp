...
<div class="container">
  ...
  <div class="text-center"> 	
  	<a href="list.do3" class="btn btn-outline-success btn-lg mt-9 mr-3" >연습 List</a>
  	<a href="input.do3" class="btn btn-outline-primary mt-6 mr-3" >연습 Input</a>
  	<a href="update.do3" class="btn btn-outline-secondary btn-sm mr-3" >연습 Update</a>
  	<a href="delete.do3" class="btn btn-outline-info mt-6 mr-3" >연습 Delete</a>
  	<a href="search.do3" class="btn btn-outline-danger btn-lg mt-9" >연습 Search</a>	
  </div>
