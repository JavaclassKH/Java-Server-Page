...
<p><br/></p>
	<div class="container">
		<div class="text-center">
			<button type="button" title="이전연도" onclick="location.href='Calendar1.st?yy=${yy-1}&mm=${mm}';" class="btn btn-secondary btn-sm">&lt;	&lt;</button>	
			<button type="button" title="이전월" onclick="location.href='Calendar1.st?yy=${yy}&mm=${mm-1}';" class="btn btn-secondary btn-sm">&lt;</button>	
			<font size="5px">${yy}년 ${mm+1}월</font>
			<button type="button" title="다음월" onclick="location.href='Calendar1.st?yy=${yy}&mm=${mm+1}';" class="btn btn-secondary btn-sm">&gt;</button>	
			<button type="button" title="다음년도" onclick="location.href='Calendar1.st?yy=${yy+1}&mm=${mm}';" class="btn btn-secondary btn-sm">&gt;	&gt;</button>	
			<button type="button" title="오늘날짜" onclick="location.href='Calendar1.st';" class="btn btn-secondary btn-sm">★</button>	
		</div>
		<br/>
		<div class="text-center">
