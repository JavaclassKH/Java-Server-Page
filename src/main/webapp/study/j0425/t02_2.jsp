  ...
  <script type="text/javascript">
  	...
  	function fCheck(){
  		...
  		if(name.value.trim() == ""){
  			...
  			// myform.submit(); // submit은 form태그에 action을 따라감  !! 서버에서는 백틱 사용 불가능 !!
...
<p><br/></p>
	<div class="container">
		<h2>값 전송연습(get/post)</h2>
		<!-- <form name="myform" method="post" action="t02Ok.jsp"> -->
		<!-- <form name="myform" method="get" action="t02Ok.jsp"> -->
			<div> 성 명
				<input type="text" name="name" id="name" value="설윤아" class="form-control mb-4" autofocus required />
			</div>
			<div> 나 이 
